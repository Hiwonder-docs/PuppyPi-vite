# PuppyPi Documentation

This repository contains the PuppyPi VitePress documentation site. The
...
The staged production files are generated in `projects/PuppyPi/en/latest/`.
...
```text
https://hiwonder-docs.github.io/PuppyPi-vite/projects/PuppyPi/en/latest/
```

The public-facing URL (via the baota Nginx reverse proxy) is:

```text
https://wiki-test.hiwonder.com/projects/PuppyPi/en/latest/
```
